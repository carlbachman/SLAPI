...
$object_mask->operatingSystemReferenceCode = 'WIN_2008-STD-SP2_64';
$object_mask->blockDevices[0]['device'] = 0;
$object_mask->blockDevices[0]['diskImage']['capacity'] = 100;
$object_mask->localDiskFlag = false;
