...
for ($cnt = 0; $cnt < $my_order->quantity; $cnt++) {
  $domain = new stdClass();
  $primaryNetworkComponent = new stdClass();
  $primaryBackendNetworkComponent = new stdClass();
  $domain->hostname = "domain-sg-$cnt";;
  $domain->domain = 'softlayer-singapore-test.com';
  $domain->localDiskFlag = false;
  $domain->hourlyBillingFlag = true;
  $domain->primaryNetworkComponent->networkVlan['id'] = 566024;
  $domain->primaryBackendNetworkComponent->networkVlan['id'] = 566034;
